		...
		<?=CHtml::beginForm('', 'POST', array(
            ...
            <table class="table table-hover">
            	<tr>
                    ...
                    <td>
                    	<select class="input-medium" id="gameId" required="required" name="PlayergoodsLog[game_id]">
							<?php
								foreach ($game as $k => $v){
                ...
                <tr>
      				...
      				<td>
      					<?=CHtml::activeTextField($model, 'awardmoney',array('value'=>'','placeholder'=>'金币', 'class'=>'input-medium'));?>
					</td>
      			</tr>
      			<tr>
      				<th style="width:130px;line-height:30px;text-align:right">钻石</th>
      				<td>
      					<?=CHtml::activeTextField($model, 'awardemoney',array('value'=>'','placeholder'=>'钻石', 'class'=>'input-medium'));?>
					</td>
      			</tr>
      			<tr>
      				<th style="width:130px;line-height:30px;text-align:right">体力</th>
      				<td>
      					<?=CHtml::activeTextField($model, 'awardtired',array('value'=>'','placeholder'=>'体力', 'class'=>'input-medium'));?>
					</td>
      			</tr>
      			<tr>
      				<th style="width:130px;line-height:30px;text-align:right">玫瑰</th>
      				<td>
      					<?=CHtml::activeTextField($model, 'awardrose',array('value'=>'','placeholder'=>'玫瑰', 'class'=>'input-medium'));?>
					</td>
      			</tr>
      			<tr>
      				<th style="width:130px;line-height:30px;text-align:right">百合</th>
      				<td>
      					<?=CHtml::activeTextField($model, 'awardlily',array('value'=>'','placeholder'=>'百合', 'class'=>'input-medium'));?>
					</td>
      			</tr>
      			<tr>
      				<th style="width:130px;line-height:30px;text-align:right">水仙</th>
      				<td>
      					<?=CHtml::activeTextField($model, 'awardnarcissus',array('value'=>'','placeholder'=>'水仙', 'class'=>'input-medium'));?>
					</td>
      			</tr>
      			<tr>
      				<th style="width:130px;line-height:30px;text-align:right">物品1</th>
      				<td>
      					<?=CHtml::activeTextField($model, 'awarditemtype1',array('value'=>'','placeholder'=>'物品ID', 'class'=>'input-medium itemtypeId'));?>
      					<span></span>
					</td>
      			</tr>
      			<tr>
      				...
      				<td>
      					<?=CHtml::activeTextField($model, 'awarditemtype2',array('value'=>'','placeholder'=>'物品ID', 'class'=>'input-medium itemtypeId'));?>
      					<span></span>
					</td>
      			</tr>
      			<tr>
      				...
      				<td>
      					<?=CHtml::activeTextField($model, 'awarditemtype3',array('value'=>'','placeholder'=>'物品ID', 'class'=>'input-medium itemtypeId'));?>
      					<span></span>
					</td>
      			</tr>
      			<tr>
      				...
      				<td>
      					<?=CHtml::activeTextField($model, 'awarditemtype4',array('value'=>'','placeholder'=>'物品ID', 'class'=>'input-medium itemtypeId'));?>
      					<span></span>
					</td>
      			</tr>
