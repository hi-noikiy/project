...
class PayLogController extends Controller{
	...
	public function _condition(&$condition){
        ...
        $condition['excelLoad'] = array(
            ...
            'B'=>array('field'=>'PayCode', 'name'=>'货币类型'),
            'C'=>array('field'=>'OrderID', 'name'=>'订单号'),
            'D'=>array('field'=>'PayMoney', 'name'=>'金额'),
            'E'=>array('field'=>'Add_Time', 'name'=>'提交时间'),
        );
	}
	...
	public function actionPlayerStatistics(){
		...
		$condition=implode($condition,' and ');
		$criteria->condition =$condition;
		$criteria->select = "PayID, sum(PayMoney) as payTotal, ServerID";
