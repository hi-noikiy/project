...
$playerId = intval($exorderno_arr[2]);
$account_id = intval($exorderno_arr[3]);
$type = $exorderno_arr[4];
$isgoods = 0;
...
$sql="insert into web_pay_log (CPID,PayID,PlayerID,data,PayName,ServerID,PayMoney,OrderID,dwFenBaoID,Add_Time,SubStat,game_id,clienttype,packageName)";
$sql=$sql." VALUES (48,$account_id,'$playerId','$PayMoney','$PayName','$server_id','$PayMoney','$order_id','$dwFenBaoID','$Add_Time','1','$game_id','$clienttype','$isgoods')";
...
if($result==0){
	...
	WriteCard_money(1,$server_id, $PayMoney,$playerId, $order_id);
}else{
	$isPay =1;
