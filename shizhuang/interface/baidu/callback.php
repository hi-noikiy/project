...
function notify_process($config = array()){
	...
	if(!$result){
		...
		if($result_account['NAME'] != $UID.'@baidu'){
			$Result["ResultCode"] =  91;
		...
		$sql=$sql." VALUES (174, $accountId,'$playerId','$payMoney','$PayName','$serverId','$payMoney','$orderId','$dwFenBaoID','$Add_Time','1','$gameId','$clienttype', '1','$isgoods')";
