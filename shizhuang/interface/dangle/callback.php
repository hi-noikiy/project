...
$result = $_GET['result'];
if($result !=1 ){
	write_log(ROOT_PATH."log","dl_callback_error_", "status is error. get=$get,".date("Y-m-d H:i:s")."\r\n");
	exit();
}
$money = $_GET['money'];
$order = $_GET['order'];
...
$sql=$sql." VALUES (21,$account_id,'$playerId','$PayMoney','$PayName','$server_id','$PayMoney','$order_id','$dwFenBaoID','$Add_Time','1','$game_id','$clienttype',1,'$isgoods')";
