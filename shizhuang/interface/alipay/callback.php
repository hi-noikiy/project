...
$player_id = $outTradeNoArr[2];
$account_id = $outTradeNoArr[3];
global $key_arr;
...
if($result && $_POST['trade_status'] == 'TRADE_SUCCESS'){
	...
	$sql=$sql." VALUES (128,$server_id,$account_id,'$PayName','$player_id','$money','$money','$out_trade_no','$dwFenBaoID','$Add_Time','1','$game_id','$clienttype',1)";
