...
$sql = "select * from web_message where game_id='$game_id' and phone='$phone' limit 1";
...
$iSql= "insert into web_message(game_id, phone, code, addtime) values('$game_id', '$phone', '$code', '$nowTime')";
