...
Source Database       : shizhuang

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2017-08-17 15:59:56
*/
...
CREATE TABLE `admin_user` (
  ...
  `UserOper` varchar(50) DEFAULT NULL,
  `UserFlag` varchar(300) DEFAULT NULL,
  `LoginIP` varchar(50) DEFAULT NULL,
  `LoginNum` int(4) DEFAULT '0',
  `LoginTime` datetime DEFAULT NULL,
  `Add_Time` datetime DEFAULT NULL,
  `zhuanfu_jurisdiction` varchar(300) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `collect` (
  ...
  PRIMARY KEY (`id`),
  KEY `accountItem` (`account_id`,`item_id`)
...
CREATE TABLE `goods` (
  ...
  `shelves_time` int(4) unsigned NOT NULL DEFAULT '0',
  `create_time` int(4) unsigned NOT NULL DEFAULT '0',
  `check_time` int(4) unsigned NOT NULL DEFAULT '0',
  `check_status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `sale_status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `name` (`shelves_time`)
...
-- ----------------------------
-- Table structure for icon_map
-- ----------------------------
DROP TABLE IF EXISTS `icon_map`;
CREATE TABLE `icon_map` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `sort` tinyint(1) DEFAULT NULL,
  `farid` int(4) DEFAULT NULL,
  `layer` int(4) DEFAULT NULL,
  `x` int(4) DEFAULT NULL,
  `y` int(4) DEFAULT NULL,
  `px` int(4) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3215 DEFAULT CHARSET=utf8;
...
CREATE TABLE `shopitem` (
  ...
  `sort2` smallint(4) unsigned NOT NULL DEFAULT '0',
  ...
  `collar` smallint(4) unsigned NOT NULL DEFAULT '0',
  `model` smallint(4) unsigned NOT NULL DEFAULT '0',
  `style1` smallint(4) unsigned NOT NULL DEFAULT '0',
  `style21` smallint(4) unsigned NOT NULL DEFAULT '0',
  `style2` smallint(4) unsigned NOT NULL DEFAULT '0',
  `style22` smallint(4) unsigned NOT NULL DEFAULT '0',
  `style3` smallint(4) unsigned NOT NULL DEFAULT '0',
  `style23` smallint(4) unsigned NOT NULL DEFAULT '0',
  `color1` smallint(4) unsigned NOT NULL DEFAULT '0',
  `color2` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pattern1` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pattern2` smallint(4) unsigned NOT NULL DEFAULT '0',
  `material1` smallint(4) unsigned NOT NULL DEFAULT '0',
  `material2` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element1` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element2` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element3` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element4` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element5` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element6` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element7` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element8` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element9` smallint(4) unsigned NOT NULL DEFAULT '0',
  `pop_element10` smallint(4) unsigned NOT NULL DEFAULT '0',
  `shoptype` smallint(4) unsigned NOT NULL DEFAULT '1',
  `price` int(4) unsigned NOT NULL DEFAULT '0',
  `emoney` int(4) unsigned NOT NULL DEFAULT '0',
  `shelves_time` int(4) unsigned NOT NULL DEFAULT '0',
  `sale_status` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `check_time` int(4) NOT NULL,
  `check_status` tinyint(1) NOT NULL DEFAULT '0',
  `create_time` int(4) NOT NULL,
  `snapicon` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `icon` (`icon`)
) ENGINE=MyISAM AUTO_INCREMENT=1792 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for shopitem_level
-- ----------------------------
DROP TABLE IF EXISTS `shopitem_level`;
CREATE TABLE `shopitem_level` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `menuid` int(11) unsigned NOT NULL DEFAULT '0',
  `shopitem_id` int(11) unsigned NOT NULL DEFAULT '0',
  `level` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `price` smallint(4) NOT NULL DEFAULT '0',
  `addtime` int(4) NOT NULL DEFAULT '0',
  `snapicon` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `shopitem_id` (`shopitem_id`) USING HASH
) ENGINE=MyISAM AUTO_INCREMENT=3344 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of shopitem_level
-- ----------------------------

-- ----------------------------
-- Table structure for shopitem_price
-- ----------------------------
DROP TABLE IF EXISTS `shopitem_price`;
CREATE TABLE `shopitem_price` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `menuid` int(11) unsigned NOT NULL,
  `name` varchar(30) NOT NULL,
  `price1` smallint(4) unsigned NOT NULL,
  `price2` smallint(4) unsigned NOT NULL,
...
-- ----------------------------
-- Records of shopitem_price
-- ----------------------------

-- ----------------------------
-- Table structure for shopitem_tem
-- ----------------------------
DROP TABLE IF EXISTS `shopitem_tem`;
CREATE TABLE `shopitem_tem` (
  `id` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `sort` smallint(2) unsigned NOT NULL DEFAULT '0',
  `sort2` smallint(2) unsigned NOT NULL DEFAULT '0',
  `name` varchar(32) NOT NULL DEFAULT '0',
  `icon` varchar(32) NOT NULL DEFAULT '0',
  `season` smallint(2) unsigned NOT NULL DEFAULT '0',
  `brand` smallint(2) unsigned NOT NULL DEFAULT '0',
  `collar` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `model` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `style1` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `style21` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `style2` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `style22` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `style3` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `style23` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `color1` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `color2` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pattern1` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pattern2` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `material1` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `material2` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element1` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element2` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element3` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element4` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element5` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element6` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element7` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element8` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element9` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `pop_element10` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `shoptype` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `price` int(4) unsigned NOT NULL DEFAULT '0',
  `emoney` int(4) unsigned NOT NULL DEFAULT '0',
  `shelves_time` int(4) unsigned NOT NULL DEFAULT '0',
  `sale_status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `check_time` int(4) NOT NULL,
  `check_status` tinyint(1) NOT NULL DEFAULT '0',
  `create_time` int(4) NOT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of shopitem_tem
-- ----------------------------

-- ----------------------------
-- Table structure for sz_level
-- ----------------------------
DROP TABLE IF EXISTS `sz_level`;
CREATE TABLE `sz_level` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `pid` int(11) unsigned NOT NULL DEFAULT '0',
  `level` char(5) NOT NULL DEFAULT '00000',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for sz_user_avatar
-- ----------------------------
DROP TABLE IF EXISTS `sz_user_avatar`;
CREATE TABLE `sz_user_avatar` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `task` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `icon` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '0',
  `type` int(4) NOT NULL DEFAULT '0',
  `sort` tinyint(1) NOT NULL DEFAULT '0',
  `name` varchar(200) CHARACTER SET utf8 NOT NULL DEFAULT '0',
  `sub_name` varchar(64) COLLATE utf8_bin DEFAULT NULL COMMENT '副标题',
  `brief_info` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '0',
  `detail` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '0',
  `unlock_lev` smallint(2) NOT NULL DEFAULT '0',
  `need_tiredness` smallint(2) NOT NULL DEFAULT '0',
  `bonus_item1` int(4) NOT NULL DEFAULT '0',
  `bonus_item2` int(4) NOT NULL DEFAULT '0',
  `bonus_money` int(4) NOT NULL DEFAULT '0',
  `bonus_emoney4` int(4) NOT NULL DEFAULT '0',
  `bonus_emoney5` int(4) NOT NULL DEFAULT '0',
  `time_begin` int(4) NOT NULL DEFAULT '0',
  `time_vote` int(4) NOT NULL DEFAULT '0',
  `time_end` int(4) NOT NULL DEFAULT '0',
  `Condition1` int(4) NOT NULL DEFAULT '0',
  `Condition2` int(4) NOT NULL DEFAULT '0',
  `Condition3` int(4) NOT NULL DEFAULT '0',
  `Condition4` int(4) NOT NULL,
  `Condition5` int(4) NOT NULL,
  `Condition6` int(4) NOT NULL,
  `Condition7` int(4) NOT NULL,
  `Condition8` int(4) NOT NULL,
  `Intersection12` tinyint(1) NOT NULL DEFAULT '0',
  `Intersection23` tinyint(1) NOT NULL DEFAULT '0',
  `Intersection34` tinyint(1) NOT NULL DEFAULT '0',
  `Intersection45` tinyint(1) NOT NULL DEFAULT '0',
  `Intersection56` tinyint(1) NOT NULL DEFAULT '0',
  `Intersection67` tinyint(1) NOT NULL DEFAULT '0',
  `Intersection78` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot1` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot2` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot3` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot4` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot5` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot6` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot7` tinyint(1) NOT NULL DEFAULT '0',
  `IsNot8` tinyint(1) NOT NULL DEFAULT '0',
  `season` smallint(2) NOT NULL DEFAULT '0',
  `state` tinyint(1) NOT NULL DEFAULT '0',
  `bg_icon` varchar(32) CHARACTER SET utf8 NOT NULL,
  `tips` varchar(255) CHARACTER SET utf8 NOT NULL,
  `vote_num` int(4) NOT NULL DEFAULT '0',
  `create_time` int(4) NOT NULL DEFAULT '0',
  `check_status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `check_time` int(4) NOT NULL DEFAULT '0',
  `bonus_exp` int(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `minute_time_begin` (`time_begin`)
...
-- ----------------------------
-- Table structure for web_erp_level_copy
-- ----------------------------
DROP TABLE IF EXISTS `web_erp_level_copy`;
CREATE TABLE `web_erp_level_copy` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
  `level` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `web_gift` (
  ...
  `used_type` int(11) unsigned NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for web_login_auto_copy
-- ----------------------------
DROP TABLE IF EXISTS `web_login_auto_copy`;
CREATE TABLE `web_login_auto_copy` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `game_id` smallint(4) unsigned NOT NULL,
  `channel` varchar(30) NOT NULL,
  `account_id` int(11) unsigned NOT NULL,
...
-- ----------------------------
-- Records of web_login_auto_copy
-- ----------------------------
...
-- ----------------------------
-- Table structure for web_menu_copy
-- ----------------------------
DROP TABLE IF EXISTS `web_menu_copy`;
CREATE TABLE `web_menu_copy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL COMMENT '名称',
  `m_id` int(11) DEFAULT NULL,
  `grade` int(11) DEFAULT NULL COMMENT '等级',
  ...
  PRIMARY KEY (`id`),
  KEY `m_id` (`m_id`)
) ENGINE=MyISAM AUTO_INCREMENT=201 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单';

-- ----------------------------
-- Records of web_menu_copy
-- ----------------------------
...
-- ----------------------------
-- Table structure for web_pay_log_old
-- ----------------------------
DROP TABLE IF EXISTS `web_pay_log_old`;
CREATE TABLE `web_pay_log_old` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `PayID` int(4) DEFAULT NULL,
  `PayName` varchar(50) DEFAULT NULL,
  `ServerID` int(4) DEFAULT NULL,
...
CREATE TABLE `web_problem` (
  ...
  `type` tinyint(1) DEFAULT '0' COMMENT '0问题反馈、1意见收集',
  PRIMARY KEY (`id`)
