...
<div id="main">
    <div id="register2">
        <h2><font size="4">问题反馈</font></h2>
        <p class="linkp" >
            如填写资料过程遇到问题， <a>请联系客服</a>
        </p>
        <form  name="RegForm" method="post" action="problem" onSubmit="return InputCheck(this)" enctype="multipart/form-data">
            <ul>
                <li>
                ...
                <li>
                  ...
                  <li>
                      <span>操作系统</span>
                      <input id ="operate" name="operate" type="text">
                  </li>
                  <li>
                      <span>系统版本</span>
                  ...
                  <li class="textli">
                      <span class="textspan">详细描述</span><font class="stars">*</font>
