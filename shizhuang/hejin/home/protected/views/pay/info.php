...
<dt><img src="webpay/recharge/icon.png" alt="衣范儿用户平台">
  ...
  <dd><a class="b2" href="javascript:history.back();">返回</a></dd>
</dl>
<div id="container">
  <dl class="pagetitle">
    <dt></dt>
  ...
  <ul class="formline">
    <li class="text"><span>游戏名：</span><span>衣范儿</span></li>
  ...
  <ul class="formline">
    <li>
      <div class="inputbutton"><a class="button" href="info?pay=ali">确认信息无误，前往支付</a></div>
    </li>
  </ul>
  <ul class="formline">
