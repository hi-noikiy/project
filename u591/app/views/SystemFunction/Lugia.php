        	...
        	if(result['data']!='')
                for(var i in result['data']){
                    ...
                    if(typeof(result['data'][i]['v0'])=='undefined'){result['data'][i]['v0']=0;}
                	 ...
                	 if(typeof(result['data'][i]['v13'])=='undefined'){result['data'][i]['v13']=0;}
                	 if(typeof(result['data'][i]['v14'])=='undefined'){result['data'][i]['v14']=0;}
                	 if(typeof(result['data'][i]['v15'])=='undefined'){result['data'][i]['v15']=0;}
                	table_html += '<tr>' +
                    ...
                    '<td>'+result['data'][i]['v13']+'</td>' +
                    '<td>'+result['data'][i]['v14']+'</td>' +
                    '<td>'+result['data'][i]['v15']+'</td>' +
                    '</tr>';
                	   }
                    }
