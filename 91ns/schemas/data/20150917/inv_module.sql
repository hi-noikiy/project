...
CREATE TABLE `inv_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='客服后台模块表';

-- ----------------------------
-- Records of inv_module
-- ----------------------------
INSERT INTO `inv_module` VALUES ('1', '0', '主页', 'index', 'icon-home', '1', '', '0', '1427169574', '1');
INSERT INTO `inv_module` VALUES ('4', '0', '推广员/水军', 'pull', 'icon-th', '4', '', '0', '1427169574', '1');
...
INSERT INTO `inv_module` VALUES ('10', '2', '分成比例', 'bonus', '', '3', '', '1', '1427169574', '0');
...
INSERT INTO `inv_module` VALUES ('28', '0', '提现', 'settle', 'icon-fullscreen', '6', '', '1', '1427169574', '1');
...
INSERT INTO `inv_module` VALUES ('47', '28', '提现提醒', 'settleremind', '', '4', '', '1', '0', '1');
INSERT INTO `inv_module` VALUES ('44', '28', '申请结算', 'index', '', '1', '', '1', '0', '0');
INSERT INTO `inv_module` VALUES ('45', '28', '已处理', 'settled', '', '3', '', '1', '0', '1');
INSERT INTO `inv_module` VALUES ('46', '28', '待处理', 'waitsettle', '', '2', '', '1', '0', '1');
INSERT INTO `inv_module` VALUES ('48', '4', '推广员', 'index', '', '1', '', '1', '0', '1');
INSERT INTO `inv_module` VALUES ('49', '4', '水军', 'navy', '', '2', '', '1', '0', '1');
INSERT INTO `inv_module` VALUES ('50', '0', '推荐位', 'recommend', 'icon-th', '9', '', '0', '0', '1');
INSERT INTO `inv_module` VALUES ('51', '2', '消息通知', 'notice', '', '6', '', '1', '1440140276', '1');
INSERT INTO `inv_module` VALUES ('52', '5', '系统公告', 'notice', '', '3', '', '1', '1440481828', '1');
INSERT INTO `inv_module` VALUES ('53', '4', '新用户推广', 'reclist', '', '3', '', '1', '1442282682', '1');
