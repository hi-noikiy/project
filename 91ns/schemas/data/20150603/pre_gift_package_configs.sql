...
CREATE TABLE `pre_gift_package_configs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='礼包配置表';
...
INSERT INTO `pre_gift_package_configs` VALUES ('10', '超值大礼包', '', '[{\"type\":0,\"coin\":1000},{\"type\":3,\"id\":10,\"num\":10,\"validity\":0},{\"type\":2,\"id\":20,\"num\":1,\"validity\":1209600}]');
INSERT INTO `pre_gift_package_configs` VALUES ('11', '土豪大礼包', '', '[{\"type\":0,\"coin\":10000},{\"type\":1,\"id\":1,\"validity\":604800},{\"type\":2,\"id\":19,\"num\":1,\"validity\":2419200},{\"type\":3,\"id\":9,\"num\":100,\"validity\":0}]');
INSERT INTO `pre_gift_package_configs` VALUES ('12', '首充礼包1', '', '[{\"type\":0,\"coin\":1000},{\"type\":1,\"validity\":604800},{\"type\":2,\"id\":21,\"validity\":864000}]');
