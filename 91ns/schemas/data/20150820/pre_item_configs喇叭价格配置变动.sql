...
CREATE TABLE `pre_item_configs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='物品配置表';

-- ----------------------------
-- Records of pre_item_configs
-- ----------------------------
INSERT INTO `pre_item_configs` VALUES ('1', '1', '银喇叭卡', '可以向正在观看的直播房间发送一条飞屏信息', '200.000', 'ylbk');
INSERT INTO `pre_item_configs` VALUES ('2', '1', '金喇叭卡', '可以向其他直播房间发送一条飞屏信息', '500.000', 'jlbk');
...
INSERT INTO `pre_item_configs` VALUES ('10', '2', '七夕织女徽章', '七夕织女徽章', '0.000', 'zhinv');
INSERT INTO `pre_item_configs` VALUES ('11', '2', '七夕牛郎徽章', '七夕牛郎徽章', '0.000', 'niulang');
