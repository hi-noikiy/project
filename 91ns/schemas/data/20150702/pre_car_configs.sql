...
CREATE TABLE `pre_car_configs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='座驾配置表';
...
INSERT INTO `pre_car_configs` VALUES ('35', '10', '呆萌木马', '', '10000', '0', '0', 'Trojan');
INSERT INTO `pre_car_configs` VALUES ('36', '10', '魔法飞毯', '', '10000', '0', '0', 'Magic_carpet');
INSERT INTO `pre_car_configs` VALUES ('37', '10', '南瓜车', '', '10000', '0', '0', 'Pumpkin_car');
INSERT INTO `pre_car_configs` VALUES ('38', '10', '保时捷', '', '10500', '0', '0', 'Porsche');
INSERT INTO `pre_car_configs` VALUES ('39', '10', '劳斯莱斯银魅', '', '15000', '0', '0', 'Silver_Ghost');
INSERT INTO `pre_car_configs` VALUES ('40', '10', '黄金战车', '', '20000', '0', '0', 'Golden_chariot');
