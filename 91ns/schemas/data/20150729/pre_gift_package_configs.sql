...
CREATE TABLE `pre_gift_package_configs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='礼包配置表';
...
INSERT INTO `pre_gift_package_configs` VALUES ('37', '周星活动奖励', '周星活动奖励', '[{\"type\":2,\"id\":41,\"num\":1,\"validity\":604800},{\"type\":4,\"id\":8,\"num\":1,\"validity\":604800}]');
INSERT INTO `pre_gift_package_configs` VALUES ('38', '新手礼包', '推荐活动的新手礼包', '[{\"type\":0,\"cash\":888},{\"type\":3,\"id\":10,\"num\":88,\"validity\":0},{\"type\":2,\"id\":30,\"num\":1,\"validity\":2592000},{\"type\":4,\"id\":9,\"num\":1,\"validity\":2592000}]');
