...
CREATE TABLE `pre_type_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='pre_base_config';
...
INSERT INTO `pre_type_config` VALUES ('21', '普通', '1', '1', '1426823606', '', '0', '1', '1');
INSERT INTO `pre_type_config` VALUES ('22', '豪华', '2', '1', '1426823611', '', '0', '1', '1');
INSERT INTO `pre_type_config` VALUES ('23', '热门', '5', '1', '1430361700', null, '0', '1', '1');
