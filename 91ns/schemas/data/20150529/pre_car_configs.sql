...
CREATE TABLE `pre_car_configs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='座驾配置表';
...
INSERT INTO `pre_car_configs` VALUES ('7', '8', '奔驰E', '', '0', '14', '0', 'Benz_E');
INSERT INTO `pre_car_configs` VALUES ('8', '4', '宾利', '富豪等级：王爵', '0', '0', '0', 'Bentley');
INSERT INTO `pre_car_configs` VALUES ('9', '4', '柯尼塞格', '富豪等级：皇帝', '0', '0', '0', 'Kenisaige');
INSERT INTO `pre_car_configs` VALUES ('10', '4', '劳斯莱斯', '富豪等级：教皇', '0', '0', '0', 'Rolls_Royce');
...
INSERT INTO `pre_car_configs` VALUES ('16', '5', '雪佛兰科迈罗', '', '0', '0', '0', 'Chevrolet_Camaro');
INSERT INTO `pre_car_configs` VALUES ('17', '6', '特斯拉', '', '0', '0', '0', 'Tesla');
INSERT INTO `pre_car_configs` VALUES ('18', '9', '兰博基尼', '', '0', '0', '0', 'Lamborghini');
...
INSERT INTO `pre_car_configs` VALUES ('25', '7', '法拉利', '', '0', '0', '0', 'Ferrari');
...
INSERT INTO `pre_car_configs` VALUES ('27', '10', '宇宙飞船', '', '888888', '0', '0', 'Spacecraft');
INSERT INTO `pre_car_configs` VALUES ('28', '10', '魔法扫帚', '', '888888', '0', '0', 'Magic_broom');
INSERT INTO `pre_car_configs` VALUES ('29', '10', '拖拉机', '', '888888', '0', '0', 'Tractor');
INSERT INTO `pre_car_configs` VALUES ('30', '10', '自行车', '', '888888', '0', '0', 'bike');
