...
INSERT INTO `pre_sign_configs` VALUES ('3', '1', '签到专属座驾（使用权：27天）', '27', '[{\"type\":0,\"ids\":\"3\"}]', '2332800');
...
INSERT INTO `pre_sign_configs` VALUES ('9', '2', '签到专属徽章，连续获得可升级（使用权：永久）', '28', '[{\"type\":0,\"ids\":\"9\"}]', '0');
