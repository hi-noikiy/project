...
CREATE TABLE `pre_car_configs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='座驾配置表';
...
INSERT INTO `pre_car_configs` VALUES ('42', '10', '比翼鸟', '传说中的鸟类，此鸟仅一翼一目，雌雄须并翼飞行，象征坚贞的爱情。', '77777', '0', '0', 'Lovebirds');
