...
CREATE TABLE `pre_type_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='pre_base_config';
...
INSERT INTO `pre_type_config` VALUES ('37', '七夕礼物', '10', '1', '1439295136', '七夕专属礼物', '0', null, null);
INSERT INTO `pre_type_config` VALUES ('38', '中秋礼物', '11', '1', '1441706610', '中秋专属礼物', '0', null, null);
