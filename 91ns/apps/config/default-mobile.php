...
$frontendConfig = array(
    'directory' => array(
        'controllersDir'    => APP_PATH . '/apps/mobile/controllers',
        'modelsDir'         => APP_PATH . '/apps/models',
        'viewsDir'          => APP_PATH . '/apps/mobile/views',
        'cacheDir'          => APP_PATH . '/apps/mobile/cache',
        'logsDir'           => APP_PATH . '/apps/mobile/logs',
    ),
