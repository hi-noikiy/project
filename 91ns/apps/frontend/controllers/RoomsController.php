...
class RoomsController extends ControllerBase {
    ...
    public function getRoomListAction() {
        if ($this->request->isPost()) {
            ...
            $result = $this->roomModule->getRoomMgrObject()->getRoomList($sortType, $uid, $skip, $limit,$roomType);
    ...
    public function startPublishFromFlashAction() {
        if ($this->request->isPost()) {
            ...
            $result = $this->roomModule->getRoomOperObject()->startPublishFromFlash($roomid);
            $this->status->ajaxReturn($result['code'], $result['data']);
        }
        $this->proxyError();
    }
    ...
    public function hotRoomAction() {
        ...
        $result = $this->roomModule->getRoomOperObject()->getJumpAnchorId();
