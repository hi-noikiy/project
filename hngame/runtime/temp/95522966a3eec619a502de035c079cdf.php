...
<section class="content-header">
    <h1>角色列表</h1>
    <ol class="breadcrumb">
        <li class="active"><i class="fa fa-dashboard"></i> 角色列表</li>
    </ol>
</section>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('notation'); ?></th>
                        ...
                        <tr>
                            ...
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="notation" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['notation']; ?></span></td>
                            <td>
                            ...
                            <td>
                                <?php echo authAction(CONTROLLER_NAME.'/authUser', 'auth_user', ['id' => $vo['id']]); ?>
