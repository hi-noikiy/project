                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('title_en'); ?><?php echo table_sort('title_en'); ?></th>
                        ...
                        <tr>
                            ...
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="title_en" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['title_en']; ?></span></td>
