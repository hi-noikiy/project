<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:65:"/data/home/hngame/public/../application/admin/view/game/edit.html";i:1510853620;s:67:"/data/home/hngame/public/../application/admin/view/public/base.html";i:1509598470;s:75:"/data/home/hngame/public/../application/admin/view/public/admin_load_t.html";i:1505569886;s:72:"/data/home/hngame/public/../application/admin/view/public/admin_top.html";i:1507990064;s:73:"/data/home/hngame/public/../application/admin/view/public/admin_left.html";i:1507990021;s:75:"/data/home/hngame/public/../application/admin/view/public/admin_bottom.html";i:1507990082;s:75:"/data/home/hngame/public/../application/admin/view/public/admin_load_b.html";i:1509956980;}*/ ?>
...
<section class="content-header">
    <h1>游戏信息</h1>
    <ol class="breadcrumb">
        <li class="active"><i class="fa fa-dashboard"></i> 游戏信息</li>
    </ol>
</section>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('name_en'); ?></label>
                                <div class="col-sm-7">
                                <input class="form-control" id="name_en" name="name_en" value="<?php echo $data['name_en']; ?>" placeholder="<?php echo \think\Lang::get('name_en'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('category'); ?></label>
                                <div class="col-sm-7">
                                <input class="form-control" name="category" value="<?php echo $data['category']; ?>" placeholder="<?php echo \think\Lang::get('category'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('recommend'); ?></label>
                                <div class="col-sm-7">
                                    <select class="form-control select2" name="recommend" style="width:100%;">
                                        <option value="0" <?php if($data['recommend'] == '0'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('recommend0'); ?></option>
                                        <option value="1" <?php if($data['recommend'] == '1'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('recommend1'); ?></option>
                                        <option value="2" <?php if($data['recommend'] == '2'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('recommend2'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('show_way'); ?></label>
                                <div class="col-sm-7">
                                    <select class="form-control select2" name="show_way" style="width:100%;">
                                        <option value="1" <?php if($data['show_way'] == '1'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('show_way1'); ?></option>
                                        <option value="2" <?php if($data['show_way'] == '2'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('show_way2'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <input class="form-control" id="video_url-input" name="video_url" value="<?php echo $data['video_url']; ?>" placeholder="使用ftp工具上传视频到/hngame/public/userfiles/video/目录下，点击按钮进行选择" >
                                        <span class="input-group-btn">
                                            <button id="video_urlBtn" class="btn" type="button">
                                                <i class="fa fa-cloud-upload"> <?php echo \think\Lang::get('Upload'); ?></i>
                                            </button>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('android_url'); ?></label>
                                <div class="col-sm-7"><input class="form-control" name="android_url" value="<?php echo $data['android_url']; ?>" placeholder="<?php echo \think\Lang::get('android_url'); ?>"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('apple_url'); ?></label>
                                <div class="col-sm-7"><input class="form-control" name="apple_url" value="<?php echo $data['apple_url']; ?>" placeholder="<?php echo \think\Lang::get('apple_url'); ?>"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('website'); ?></label>
                                <div class="col-sm-7"><input class="form-control" name="website" value="<?php echo $data['website']; ?>" placeholder="<?php echo \think\Lang::get('website'); ?>"></div>
                            </div>
                            <div class="form-group">
...
$(function(){
    ...
    var video_urlBtn = document.getElementById( 'video_urlBtn' );
    video_urlBtn.onclick = function() {
        elementId='video_url';
        selectFileWithCKFinder();
    };
