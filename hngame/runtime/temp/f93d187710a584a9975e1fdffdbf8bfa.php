<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:73:"/data/home/hngame/public/../application/admin/view/website_info/edit.html";i:1510295211;s:67:"/data/home/hngame/public/../application/admin/view/public/base.html";i:1509598470;s:75:"/data/home/hngame/public/../application/admin/view/public/admin_load_t.html";i:1505569886;s:72:"/data/home/hngame/public/../application/admin/view/public/admin_top.html";i:1507990064;s:73:"/data/home/hngame/public/../application/admin/view/public/admin_left.html";i:1507990021;s:75:"/data/home/hngame/public/../application/admin/view/public/admin_bottom.html";i:1507990082;s:75:"/data/home/hngame/public/../application/admin/view/public/admin_load_b.html";i:1509956980;}*/ ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"><input class="form-control" id="title_en" name="title_en" value="<?php echo $data['title_en']; ?>" placeholder="<?php echo \think\Lang::get('title_en'); ?>"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('type'); ?></label>
                                <div class="col-sm-7">
                                    <select class="form-control select2" name="type" style="width:100%;">
                                        <option value="1" <?php if($data['type'] == '1'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('type1'); ?></option>
                                        <option value="2" <?php if($data['type'] == '2'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('type2'); ?></option>
                                        <option value="3" <?php if($data['type'] == '3'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('type3'); ?></option>
                                        <option value="4" <?php if($data['type'] == '4'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('type4'); ?></option>
                                    </select>
                                </div>
                            </div>
  <!--                           <div class="form-group">
                  ...
                  <button id="image_urlBtn" class="btn" type="button">
                      <i class="fa fa-cloud-upload"> <?php echo \think\Lang::get('Upload'); ?></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                <div class="input-group"><textarea class="form-control" id="content" name="content" placeholder="<?php echo \think\Lang::get('content'); ?>"><?php echo $data['content']; ?></textarea>
                                <span class="input-group-btn">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('content_en'); ?></label>
                                <div class="col-sm-7"><textarea class="form-control" id="content_en" name="content_en" placeholder="<?php echo \think\Lang::get('content_en'); ?>"><?php echo $data['content_en']; ?></textarea></div>
                            </div>
                            <div class="form-group">
