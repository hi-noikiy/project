                    ...
                    <div class="row">
                        <form id="search_form" method="get" action="">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <div class="fg-line">
                                        <input  title="等级" type="text" name="lev_min" class="form-control" placeholder="等级区间(最小等级)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <div class="fg-line">
                                        <input  title="等级(最大等级)" type="text" name="lev_max" class="form-control" placeholder="等级区间(最大等级)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
        ...
        callback: function (result) {
            if (result) {
                ...
                for (var date in result['data']) {
                    ...
                    table_html += '<tr>' +
                        '<td>'+date+'</td>'+
                        '<td>'+result['data'][date]['total_user']+'</td>'+
                        '<td>'+(result['data'][date].hasOwnProperty(0) ? result['data'][date][0] : 0)+'</td>'+
                        '<td>'+(result['data'][date].hasOwnProperty(1) ? result['data'][date][1] : 0)+'</td>'+
                        '<td>'+(result['data'][date].hasOwnProperty(2) ? result['data'][date][2] : 0)+'</td>'+
                        '<td>'+(result['data'][date].hasOwnProperty(3) ? result['data'][date][3] : 0)+'</td>'+
                        '<td>'+(result['data'][date].hasOwnProperty(4) ? result['data'][date][4] : 0)+'</td>'+
                        '<td>'+(result['data'][date].hasOwnProperty(5) ? result['data'][date][5] : 0)+'</td>'+
                        '<td>'+(result['data'][date].hasOwnProperty(6) ? result['data'][date][6] : 0)+'</td>'+
                        '</tr>';
                }
