...
<script>
    ...
    var dataOption = {
        title:'',
        autoload: true,
        request_url:'<?php echo site_url('Home/summary_by_platform');?>',
            ...
            if (result) {
                ...
                for (var i in result.data) {
                    ...
                    '<td>'+result['data'][i]['rare']+'</td>' +
                        ...
                        '<td>'+result['data'][i]['remain_rate_1']+'</td>' +
                        '<td>'+result['data'][i]['remain_rate_3']+'</td>' +
                        '<td>'+result['data'][i]['remain_rate_7']+'</td>' +
                        '<td>'+result['data'][i]['remain_rate_15']+'</td>' +
                        '<td>'+result['data'][i]['remain_rate_30']+'</td>' +
                        '</tr>';
                }
