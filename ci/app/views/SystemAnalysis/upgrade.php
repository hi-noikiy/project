                ...
                <div class="card-body card-padding">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class="fg-line">
                                    <input title="玩家ID" type="number" name="accountid"
                                           class="form-control" placeholder="玩家ID(ACCOUNT ID)">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-2">
...
<script>
    var dataOption = {
        title:'',
        autoload: false,
        request_url:'<?php echo site_url('SystemAnalysis/getUpgrade');?>',
            ...
            if (result) {
                ...
                for (var i=0;i<len; i++) {
                    table_html += '<tr>' +
                        ...
                        '<td>'+(result['data'][i]['upgrade_time'] / 60).toFixed(2)+'</td>' +
