...
$where='';
if($depId!=0)
	$where=' and a.depId='.$depId;
if($uid!=0)
	$where+=' and a.uid='.$uid;
$sql="select sum(a.totalTime) as sumtotalTime, a.*, b.real_name from _web_leave_filing a 
		left join _sys_admin b on a.uid=b.id  where a.fromTime>='$from' and a.fromTime<='$to' and a.available=1 $where group by a.uid,a.fromTime order by a.depId asc,a.uid asc, a.id desc;";
