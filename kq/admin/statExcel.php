...
<table cellspacing="0" cellpadding="0" border="1">
    <tr>
      ...
      <th scope="col" class="N_title">加班+上班时间</th>
      ...
      <th scope="col" class="N_title">实际上班时间</th>
    </tr>
    <tr class="Ls2">
    ...
    <tr class="Ls2">
        ...
        <td class="N_title"><?=floor(($val['total']+$val['over']*60)/60)."小时".(($val['total']+$val['over']*60)%60)."分钟"?></td>
