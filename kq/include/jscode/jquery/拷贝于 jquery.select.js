...
(function($){
	...
	$.fn.multiSelect.createTrTd = function(select_id){
		...
		for(var i=0;i<childLength;i++){
			...
			trtd += '<div mouse="true" style="border:1px solid #FFFFFF;cursor:default;line-height:20px;padding:0 2px;font-size: 12px;"><input type="checkbox" name="'+select_id+'[]" value="'+val+'" txt="'+text+'" /> '+text+'</div>';
		}
		return trtd;
	}
