...
?>
    ...
    <tr>
      <td class="N_title">加班时间：</td><td class="N_title" colspan="7">
...
//               $.post("ajax/check_info.php", { action: "check", class_name: class_name,time:left_time_start },
//                function(data){
//                   // alert(data+"ddddd");
//                    if(data=='ok'){ return true;}else{
//                       alert('cc');
//
//
//
...
function checkForm_back(c_date,class_name){
