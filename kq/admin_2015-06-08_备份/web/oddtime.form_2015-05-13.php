...
<?php
    if($_GET['id']){
        $strs = acTime();//计算时间戳
        $n =  strtotime($info['supdate'].' '.$info['from'])-$strs;//时间差
        //$n = 1;
...
?>
    ...
    <tr>
      <td class="N_title">时间段：</td><td class="N_title" colspan="7">
       日期:<input type="text" name="supdate" size="10"  readonly><br>
       <!--
       &nbsp;&nbsp;<input type="checkbox" name="timepoint[]" class="tp" value="09:00:00" <? echo ereg('09:00',$info['addtime'])?'checked':'';?> disabled>09:00:00
                <input type="checkbox" name="timepoint[]" class="tp" value="12:00:00"  <? echo ereg('12:00',$info['addtime'])?'checked':'';?>  disabled>12:00:00
                &nbsp;&nbsp;<input type="checkbox" name="timepoint[]" class="tp" value="13:30:00" <? echo ereg('13:30',$info['addtime'])?'checked':'';?> disabled>13:30:00
                <input type="checkbox" name="timepoint[]" class="tp" value="18:30:00" <? echo ereg('18:30',$info['addtime'])?'checked':'';?> disabled>18:30:00
      -->
    ...
    <tr>
      <td class="N_title">原由：</td><td class="N_title" colspan="7">
   ...
   <tr>
       <td class="N_title">门禁时间：</td><td class="N_title" colspan="7"><?
        //显示相关打卡时间
    ...
    <tr>
       <td class="N_title">指纹时间：</td><td class="N_title" colspan="7"><?
        //显示相关打卡时间
    ...
    ?>
            ...
            <tr>
              <td class="N_title">时间段：</td><td class="N_title" colspan="7">
                ...
                &nbsp;&nbsp;早上上班:<input type="checkbox" name="ck" value="amstart" class="tp" onclick="change_status(this)"><input type="text" name="amstart" id="amstart" value="09:00" maxlength="5" size="5" disabled><br>
                &nbsp;&nbsp;早上下班:<input type="checkbox" name="ck" value="amend" class="tp" onclick="change_status(this)"><input type="text" name="amend" id="amend" value="12:00" maxlength="5" size="5" disabled><br>
                &nbsp;&nbsp;下午上班:<input type="checkbox" name="ck" value="pmstart" class="tp" onclick="change_status(this)"><input type="text" name="pmstart" id="pmstart" value="13:30" maxlength="5" size="5" disabled><br>
                &nbsp;&nbsp;下午下班:<input type="checkbox" name="ck" value="pmend" class="tp" onclick="change_status(this)"><input type="text" name="pmend" id="pmend" value="18:30" maxlength="5" size="5" disabled>
