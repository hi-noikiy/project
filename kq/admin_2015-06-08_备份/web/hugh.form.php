...
if ($_GET ['id']) {
	$strs = acTime ();
	$n = strtotime ( $info ['fromTime'] . ' ' . $info ['hour_s'] . ':' . $info ['minute_s'] . ':00' ) - $strs; 
	// 时间差                                                                                         
	// $n =1;
	...
	<tr>
		...
		<td class="N_title" colspan="7"><input type="text" name="totalTime" size="10" id="totalTime" readonly></td>
	</tr>
	<tr>
	...
	<tr style="display: none;" id="depshow">
		...
		<td class="N_title" colspan="7"><?=htmlEdit('noPassDep',$info['noPassDep'])?></td>
	</tr>
	<tr>
	...
	<tr style="display: none;" id="pershow">
		<td class="N_title">不通过理由：</td>
		<td class="N_title" colspan="7"><?=htmlEdit('noPassPer',$info['noPassPer'])?></td>
	</tr>
	<tr>
	...
	<tr style="display: none;" id="manshow">
		<td class="N_title">不通过理由：</td>
		<td class="N_title" colspan="7"><?=htmlEdit('noPassMan',$info['noPassMan'])?></td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		<td class="N_title">申请人：</td>
		<td class="N_title" colspan="7">
			<input type="text" size="20" name='name' value="<?=$userinfo['real_name']?>" readonly>
			<input type="hidden" name="uid" value="<?=$uid?>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="N_title" colspan="7">
			从：
			<input type="text" name="fromTime" size="10" id="date_s" onchange="totaltime();" readonly> <?php addTime('s');?>
			到：
	        ...
	        <?php
				...
				echo '&nbsp;&nbsp;<font color="red">可申请调休时间:' . number_format ( $admininfo ['totalOverTime'] / 60, 1 ) . "小时,已申请调休时间:" . number_format ( $admininfo ['reserve'] / 60, 1 ) . "小时,还可申请:" . number_format ( ($admininfo ['totalOverTime'] - $admininfo ['reserve']) / 60, 1 ) . "小时<br/>&nbsp;&nbsp;" . C_LANG . "</font>";
			?>
	...
	<tr>
		<td class="N_title">合计：</td>
		<td class="N_title" colspan="7"><input type="text" name="totalTime" size="10" id="totalTime" readonly>小时</td>
	</tr>
	<tr>
		<td class="N_title">事由：</td>
		<td class="N_title" colspan="7"><?=htmlEdit('reason',$info['reason'])?></td>
