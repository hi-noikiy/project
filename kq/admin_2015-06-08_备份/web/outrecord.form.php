...
?>
    ...
    <tr>
      <td class="N_title">外出时间：</td><td class="N_title" colspan="7">
        从：<input type="text" name="fromTime" size="10"  readonly> <?php addTimeM('s','disabled',$info['hour_s'],$info['minute_s']);?>到：
        <input type="text" name="toTime" size="10"  readonly><?php addTimeM('e','disabled',$info['hour_s'],$info['minute_s']);?>
        <br>
      </td>
    </tr>
    <tr>
   ...
   <tr>
    ...
    <tr>
       <td class="N_title">指纹时间：</td><td class="N_title" colspan="7"><?
        //显示相关打卡时间
            searzhiwentime($info['fromTime'],$info['fromTime'],$info['uid']);
            echo "注:s后缀表异常时间";
        ?>
        </td>
    </tr>
    ...
    ?>
            ...
            <tr>
              <td class="N_title">外出时间：</td><td class="N_title" colspan="7">
                  从：<input type="text" name="fromTime" size="10" id="date_s" onchange="totaltime();"  readonly> <?php addTimeM('s');?>到：
        <input type="text" name="toTime" size="10" id="date_e" onchange="totaltime();"  readonly><?php addTimeM('e');?>
        ...
        <font color="red">&nbsp;&nbsp;<?php echo C_LANG ?></font>
            ...
            <tr>
              <td class="N_title">合计：</td><td class="N_title" colspan="7">
                  ...
                  <input type="hidden" name="totalM" size="10" id="totalM" readonly>
              </td>
            </tr>
            <tr>
              <td class="N_title">事由：</td><td class="N_title" colspan="7">
