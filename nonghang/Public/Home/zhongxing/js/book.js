...
myApp.onPageInit('confirmOrder', function (page) {
    ...
    var fixedPrice = parseInt($('.fixedPrice').text()),
        inputV = parseInt($('#unitsc').val()),//默认值
        unitPrice = parseInt($('#wp').val());
    ...
    $('#confirmOrder_num').keyup(function(){
        ...
        var inputObj = $(this),
            ...
            minVal = 1,
            inputVal = parseInt(inputObj.val()),
            costObj = $('.price');
        ...
        if(inputVal <= inputV ){
            ...
            if(!isNaN(inputVal)){
                if(inputVal>inputV){
                    ...
                    costObj.text(unitPrice*(inputVal) + fixedPrice);
                }
            }else{
                costObj.text('');
            }
