...
class WholeReserveViewModel extends ViewModel{
		public $viewFields=array(
				...
				'whole_reserve'=>array('id','viewingDate','num','paymentMethod','filmNo','paymentState','state','changeState','total','prepay','code','paymentTime','tel','detail','adminUid','checkTime','_type'=>'LEFT'),
				'whole_video_information'=>array('topicName','_on'=>'whole_reserve.videoId=whole_video_information.id' ,'_type'=>'LEFT'),
