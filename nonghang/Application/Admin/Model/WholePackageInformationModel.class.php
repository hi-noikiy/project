...
class WholePackageInformationModel extends Model {
	var $tablename="whole_package_information";
    /**
     *
     *功能：添加信息
     *
...
//        	$wherearray['id']=array('exp','in (select relationId from zx_whole_reserve_relation where type=1 and reserveId="'.$dataarray['reserveId'].'")');            
//        }
