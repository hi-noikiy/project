...
$config['mongo_db']['test']['username'] = 'test';
$config['mongo_db']['test']['password'] = 'test';
...
$config['mongo_db']['admin']['hostname'] = 'localhost';
$config['mongo_db']['admin']['port'] = '27017';
$config['mongo_db']['admin']['username'] = 'admin';
$config['mongo_db']['admin']['password'] = 'admin';
$config['mongo_db']['admin']['database'] = 'admin';
$config['mongo_db']['admin']['db_debug'] = TRUE;
$config['mongo_db']['admin']['return_as'] = 'array';
$config['mongo_db']['admin']['write_concerns'] = (int)1;
$config['mongo_db']['admin']['journal'] = TRUE;
$config['mongo_db']['admin']['read_preference'] = NULL;
$config['mongo_db']['admin']['read_preference_tags'] = NULL;
