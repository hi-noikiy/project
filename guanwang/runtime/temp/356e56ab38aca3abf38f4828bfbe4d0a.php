<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:121:"C:\Users\Administrator\AppData\Roaming\HBuilder\userprofiles\offline\game\public/../application/war\view\index\index.html";i:1521769092;s:116:"C:\Users\Administrator\AppData\Roaming\HBuilder\userprofiles\offline\game\public/../application/war\view\header.html";i:1521096084;s:116:"C:\Users\Administrator\AppData\Roaming\HBuilder\userprofiles\offline\game\public/../application/war\view\footer.html";i:1520417140;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
	<meta name="keywords" content="魔兽小宠物,宠物养成,魔兽世界,宠物小精灵,手游,游戏,免费手游,养成,收集" /> 
	<meta name="description" content="《魔兽小宠物》是一款魔兽小宠物收集养成、GBA策略对战、RPG角色冒险的手机游戏。" /> 
    ...
    <link rel="stylesheet" type="text/css" href="__static__/war/css/switch.css" />
</head>
<body>
<header id="top">
	<!--<div class="langage">
        ...
        <div class="dl">
            ...
            <div class="dl_btn">
                <a class="ios" href="<?php echo $pokemon['apple_url']; ?>" target="_blank">
                    <img style="left:18px;top:11px;" src="__static__/war/img/ios.png">IOS下载
                </a>
                <a class="adr" href="<?php echo $pokemon['android_url']; ?>" target="_blank">
                    <img style="left:12px;top:10px;" src="__static__/war/img/adr.png">安卓下载
                </a>
            </div>
            <a class="dl_gift" href="javascript:;">
                <img src="__static__/war/img/gift.png">
                <!--<div class="gift">领取礼包</div>-->
            </a>

        </div>
    </div>
    <img class="index_1_bg" src="__static__/war/img/bg.jpg"/>
    <div class="index_1_content ">
        <div class="position_fix_btm">
            <div class="content clearfix">
                ...
                <div class="list_box">
                    <ul class="list_tit clearfix">
                    	<li class="active"><a href="javascript:void(0)">最新</a><img class="triangle" src="__static__/war/img/blue_triangle.png"></li>
                        <?php if(is_array($newsTypeList) || $newsTypeList instanceof \think\Collection || $newsTypeList instanceof \think\Paginator): $i = 0; $__LIST__ = $newsTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <li><a href="javascript:void(0)"><?php echo $vo['name']; ?></a><img class="triangle" src="__static__/war/img/blue_triangle.png"></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <a class="more" href="<?php echo url('News/news'); ?>">+</a>
                    </ul>
            ...
            <div class="content clearfix" style="margin-top:70px">
                ...
                <a href="<?php echo (isset($vo['url']) && ($vo['url'] !== '')?$vo['url']:'javascript:void(0)'); ?>" target="_blank" class="switch_block">
...
<div class="index_2">
    <img class="index_2bg" src="__static__/war/img/index_2.png">
    <div class="content">
...
<div class="alert-win" style="display: none">
    <img class="close" src="__static__/war/img/close.png">
    <div class="item"><span>恭喜你！</span>获得</div>
    <div class="item">《魔兽小宠物》官网特权礼包</div>
