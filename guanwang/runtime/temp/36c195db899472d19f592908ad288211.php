<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:80:"F:\wamp\www\project\guanwang\public/../application/admin\view\vs_news\index.html";i:1515641079;s:78:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\base.html";i:1515641079;s:86:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_load_t.html";i:1515641079;s:83:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_top.html";i:1515641079;s:84:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_left.html";i:1515641079;s:84:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\top_action.html";i:1515641079;s:80:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\search.html";i:1515641079;s:85:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\list_action.html";i:1515641079;s:86:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_bottom.html";i:1515641079;s:86:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_load_b.html";i:1515641079;}*/ ?>
...
<section class="content-header">
    <h1>新闻列表(口袋妖怪)</h1>
    <ol class="breadcrumb">
        <li class="active"><i class="fa fa-dashboard"></i> 新闻列表(口袋妖怪)</li>
    </ol>
</section>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('writer'); ?></th>
                            <th><?php echo \think\Lang::get('click'); ?><?php echo table_sort('click'); ?></th>
                            <th><?php echo \think\Lang::get('thumb_up'); ?><?php echo table_sort('thumb_up'); ?></th>
                            <th><?php echo \think\Lang::get('create_time'); ?><?php echo table_sort('create_time'); ?></th>
                        ...
                        <tr>
                            ...
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="title" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['title']; ?></span></td>
                            <td><?php echo $vo['VsNewsType']['name']; ?></td>
                            <td><?php echo $vo['User']['name']; ?></td>
                            <th><?php echo $vo['click']; ?></th>
                            <th><?php echo $vo['thumb_up']; ?></th>
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="__static__/pokemon/page/yulan.html?src=/public/index.php/pokemon/news/detail?id=1" target="_blank"><i class="fa fa-eye"></i> <?php echo \think\Lang::get('preview'); ?></a>
                                <?php echo authAction(CONTROLLER_NAME.'/edit', 'edit', ['id' => $vo['id']]); ?> 
<?php echo authAction(CONTROLLER_NAME.'/delete', 'delete', $vo['id']); ?> </td>
                        </tr>
