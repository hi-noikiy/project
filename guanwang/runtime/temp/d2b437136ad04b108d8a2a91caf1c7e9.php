    ...
    <div class="moblie_content">
    	<div class="card_list">
                <div class="top_block clearfix">
                    <img src="__static__/war/img/ball.png">
                    <div class="right">
                        <h1>sdffffffff</h1>
                        <p>活动时间：<span>45</span>—<span>45</span></p>
                    </div>
                </div>
                <div class="tips">
                    dfssssssssssssss
                ...
                <a class="hide">
                    ...
                    <p>
                       werrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
                    </p>
                </a>
            </div>
        ...
        <?php if(is_array($activityList) || $activityList instanceof \think\Collection || $activityList instanceof \think\Paginator): $k = 0; $__LIST__ = $activityList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if($vo['type'] == 2): ?>
            <div class="card_list">
                <div class="top_block clearfix">
                    ...
                    <img class="m_end" src="__static__/war/img/end.png">
                </div>
                <div class="tips">
                    <?php echo $vo['description']; ?>
                </div>
