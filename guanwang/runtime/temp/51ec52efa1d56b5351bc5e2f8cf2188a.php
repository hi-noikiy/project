<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:123:"C:\Users\Administrator\AppData\Roaming\HBuilder\userprofiles\offline\game\public/../application/pokemon\view\news\news.html";i:1521603024;s:120:"C:\Users\Administrator\AppData\Roaming\HBuilder\userprofiles\offline\game\public/../application/pokemon\view\header.html";i:1521096116;s:120:"C:\Users\Administrator\AppData\Roaming\HBuilder\userprofiles\offline\game\public/../application/pokemon\view\footer.html";i:1519619557;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="news_block1">
    <img class="show" src="__static__/pokemon/img/news_top.jpg">
    <div class="news_nav">
        ...
        <div class="content list_line clearfix">
            ...
            <div class="list_content">
            	<a href="javascript:openDetail(<?php echo $news['id']; ?>)" class="tit">
                	<p><?php echo $news['title']; ?></p><img class="selected_img" src="__static__/pokemon/img/pokeball.png">
                </a>
                <a href="javascript:openDetail(<?php echo $news['id']; ?>)" class="tit">
	                <div class="text">
        ...
        $.ajax({
            ...
            success : function(datas) {
                ...
                for (var i = 0; i<datas.newsList.length; i++) {
                    ...
                    var dataHTML='<div class="news_list"><div class="content list_line clearfix">'+timeHTML+'<div class="list_content"><a href="javascript:openDetail('+data['id']+')" class="tit"><p>'+data['title']+'</p><img class="selected_img" src="'+basePath+'/pokemon/img/pokeball.png"></a><a href="javascript:openDetail('+data['id']+')" class="tit"><div class="text">'+data['description']+'</div></a></div></div></div>';
