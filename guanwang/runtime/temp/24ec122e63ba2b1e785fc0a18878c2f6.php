...
<section class="content-header">
    <h1>新闻类型</h1>
    <ol class="breadcrumb">
        <li class="active"><i class="fa fa-dashboard"></i> 新闻类型</li>
    </ol>
</section>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                <input class="form-control" id="name" name="name" value="<?php echo $data['name']; ?>" placeholder="<?php echo \think\Lang::get('name'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
