<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"F:\wamp\www\project\guanwang\public/../application/pokemon\view\index\mobile_us.html";i:1516074148;s:85:"F:\wamp\www\project\guanwang\public/../application/pokemon\view\header_mobile_us.html";i:1515658037;s:85:"F:\wamp\www\project\guanwang\public/../application/pokemon\view\footer_mobile_us.html";i:1516002709;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
<div id="fullpage">
    <div class="section" style="background:url('__static__/pokemon/img/english/moblie_indexBg.png') center center no-repeat;background-size: 100% 100%;" id="index_1">
                <div class="top_down">
            <div class="moblie_content">
                <img class="ball" src="__static__/pokemon/img/english/ball.png">
                <div class="moblie_top_text">
                    <h1>《Pokemon VS》</h1>
                    <p>3D remake of pokemon</p>
                </div>
                <a class="down_load" href="javascript:downLoadApp();">
                    <img src="__static__/pokemon/img/english/download_btn.png">
                </a>
            </div>
        </div>
        ...
        <a id="load" href="javascript:downLoadApp();">
            <img src="__static__/pokemon/img/english/down_load.png">
        </a>
        <img class="down_tip" src="__static__/pokemon/img/english/down_arrow.png">
    </div>
    <div class="section" id="index_2">
        ...
        <div class="index_2_content">
            <div class="moblie_content">
                ...
                <div class="moblie list_box">
                    <ul class="list_tit clearfix">
                        <?php if(is_array($newsTypeList) || $newsTypeList instanceof \think\Collection || $newsTypeList instanceof \think\Paginator): $i = 0; $__LIST__ = $newsTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <li <?php if($key == 0): ?>class="active"<?php endif; ?>><a href="javascript:void(0)"><?php echo $vo['name']; ?></a><img class="triangle" src="__static__/pokemon/img/english/blue_triangle.png"></li>
                    ...
                    <div class="list_block" id="list_<?php echo $key; ?>" <?php if($key > 0): ?>style="display: none;"<?php endif; ?>>
                        <div class="list_first">
                            ...
                            <img class="bird" src="__static__/pokemon/img/english/nan_bird.png">
                        </div>
                ...
                <div class="moblie index_tit" style="font-size: 18px;">
                    Game features
                </div>
                ...
                <div class="bottom_tel">
                    <img class="tel_moblie" src="__static__/pokemon/img/english/tel_11.png?t=123">
...
<div id="cover">
    ...
    <div class="cover-text">
        <p>Long press the qr code to save the picture</p>
        <p>Focus on pokemon VS game official public number</p>
    </div>
</div>
