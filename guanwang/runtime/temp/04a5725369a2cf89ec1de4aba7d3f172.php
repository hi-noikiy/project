<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:79:"F:\wamp\www\project\guanwang\public/../application/admin\view\vs_news\edit.html";i:1515738812;s:78:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\base.html";i:1515641079;s:86:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_load_t.html";i:1515641079;s:83:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_top.html";i:1515641079;s:84:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_left.html";i:1515641079;s:86:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_bottom.html";i:1515641079;s:86:"F:\wamp\www\project\guanwang\public/../application/admin\view\public\admin_load_b.html";i:1515641079;}*/ ?>
            ...
            <form class="form-horizontal" method="POST" action="" onsubmit="return false" >
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"><textarea class="form-control" style="resize:none;height:80px;" id="description" name="description" placeholder="<?php echo \think\Lang::get('description'); ?>"><?php echo $data['description']; ?></textarea></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('type_name'); ?></label>
                                <div class="col-sm-7">
                                    <select class="form-control select2" name="type_id" style="width:100%;">
                                        <?php if(is_array($vsNewsTypeList) || $vsNewsTypeList instanceof \think\Collection || $vsNewsTypeList instanceof \think\Paginator): $i = 0; $__LIST__ = $vsNewsTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $vo['id']; ?>" <?php if(($vo['id'] == $data['type_id']) and ($data['type_id'] != -1)): ?>selected="selected"<?php endif; ?>>
                                            <?php echo $vo['name']; ?>
                                        </option>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('author'); ?></label>
                                <div class="col-sm-7"><input class="form-control" name="author" value="<?php echo $data['author']; ?>" placeholder="<?php echo \think\Lang::get('author'); ?>"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control select2" name="lang" style="width:100%;">
                                        <option value="" <?php if($data['lang'] == ''): ?>selected="selected"<?php endif; ?> >中文</option>
                                        <option value="us" <?php if($data['lang'] == 'us'): ?>selected="selected"<?php endif; ?> >英文</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-sm-7">
                            <div class="btn-group">
                                <button id="vsNewsSubmit" type="submit" class="btn btn-info submits" data-loading-text="&lt;i class='fa fa-spinner fa-spin '&gt;&lt;/i&gt; <?php echo \think\Lang::get('submit'); ?>"><?php echo \think\Lang::get('submit'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
