<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"F:\wamp\www\project\guanwang\public/../application/pokemon\view\news\detail_mobile.html";i:1516074900;s:82:"F:\wamp\www\project\guanwang\public/../application/pokemon\view\header_mobile.html";i:1515641079;s:82:"F:\wamp\www\project\guanwang\public/../application/pokemon\view\footer_mobile.html";i:1515641079;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="bread">
    <div class="moblie_content moblie_nav">
        <a href="javascript:openIndex()">官网首页</a><a href="javascript:openNews()">新闻资讯</a><a href="javascript:void(0)">正文</a>
    </div>
</div>
...
<div class="detail_tit_m">
    <div class="moblie_content">
        ...
        <div class="mess clearfix">
            <div class="l">作者：<span><?php echo $data['author']; ?></span></div>
...
<div class="detail_content_m" style="width: 100%;overflow: hidden;">
    ...
    <div class="share_heart">
        ...
        <a href="javascript:void(0)" class="heart share" id="share">
            <div class="share_icon"></div> <span>分享</span>
        </a>
    </div>
</div>
